...
<main class="booking-page">
    <section class="inner-banner">
        <div class="container">
            <h1 class="text-center">Map Out <b>Your Adventure</b></h1>
        </div>
        <figure class="banner-img">
            <img src="assets/images/banner/mount.png" alt="">
        </figure>
    </section>
    <section class="contact-section section-break">
        <div class="container">
            <div class="heading-wrapper">
                <h3 class="heading-ext">"Start Your Adventure Today! Book Now and Create Memories That Last a Lifetime."
                </h3>
            </div>
                    ...
                    <div class="booking-form">
                        <form action="">
                            <div class="row gy-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label">Date of Travel
                                            <span class="color-red">*</span>
                                        </label>
                                        <div class="input-group">
                                            <input type="date" class="form-control" placeholder="Phone No.">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="form-label">Trip duration(days)
                                            <span class="color-red">*</span>
                                        </label>
                                        <div class="input-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="form-label">No. of childrens
                                            <span class="color-red">*</span>
                                        </label>
                                        <div class="input-group">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="form-label">More Information
                                            <span class="color-red">*</span>
                                        </label>
                                        <div class="input-group">
                                            <textarea rows="5" placeholder="More Information"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="form-control select-with-search" id="country" name="country">
